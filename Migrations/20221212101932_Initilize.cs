    ...
    public partial class Initilize : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FreelancerHobbies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FreelancerHobbies_FreelancerHobbies_HobbyId",
                        column: x => x.HobbyId,
                        principalTable: "FreelancerHobbies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FreelancerHobbies_FreelancerInformations_FreelancerInformationId",
                        column: x => x.FreelancerInformationId,
                        principalTable: "FreelancerInformations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Countries",
                columns: new[] { "Id", "Name" },
                values: new object[] { 1, "Uzbekistion" });
            ...
            migrationBuilder.InsertData(
                table: "Positions",
                columns: new[] { "Id", "Name" },
                values: new object[] { 1, "Web Designer" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FreelancerHobbies_FreelancerInformationId",
