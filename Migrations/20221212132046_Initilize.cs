        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FrelancerInformationId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FrelaceInfoId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FreelancerContacts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FreelancerContacts_FreelancerInformations_FreelancerInformationId",
                        column: x => x.FreelancerInformationId,
                        principalTable: "FreelancerInformations",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                table: "FreelancerContacts",
                columns: new[] { "Id", "Facebook", "FreelancerInformationId", "GitHub", "Instagram", "Telegram", "Twitter", "WatsApp", "WebSite" },
                values: new object[] { 1, "eeeeeeeeeee", null, "asasasa", "asasasa", "sasasa", "sasasa", "sasasa", "sasasa" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FreelancerContacts_FreelancerInformationId",
                table: "FreelancerContacts",
                column: "FreelancerInformationId");
